...
<html>
 ...
 <body>
  ...
  <form method="post" name="analyse">
   ...
   <input type="hidden" name="result" value="app2 return custom result!">
  </form>


  <form method="get" name="analyse" action="http://files.<?php echo $_SERVER['HTTP_HOST']; ?>/$/result">  
   <input type="hidden" name="result" value="app2 return custom result! this text is ... به فارسی هم میتواند پاسخ دهد!">
