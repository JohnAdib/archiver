...
/* MediumButton  1.0 (24.02.2015) | https://github.com/arcs-/MediumButton */
...
route('*', function() {
	var els = $('.editor', this).get();
	editor = new MediumEditor(els, {
		targetBlank: true,
		toolbar:
		{
			buttons:
			[
			'bold', 'italic', 'underline', 'quote', 'anchor', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'orderedlist', 'unorderedlist', 'h2', 'h3', 'anchor', 'superscript', 'reference', 'footnote', 'removeFormat', 
			],
			autoLink: true,
		...
		extensions:
		{
			'reference': new MediumButton({
				label:'<i class="fa fa-book" title="add new reference"></i>',
			...
			'footnote': new MediumButton({
				label:'<i class="fa fa-bookmark" title="add new footnote"></i>',
				action: function(html, mark)
				{
					if(html == '')
						html = '#';
					return '<span data-ref-type="inline" contenteditablea="false">' + html + '</span>';
				}
			}),
...
function aa(){
	$("[data-ref-type]").focus(function(event) {
		console.log(60)
	});
}