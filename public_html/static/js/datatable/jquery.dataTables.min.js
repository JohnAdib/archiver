...
route('*', function()
{
  var lang  = document.documentElement.lang.slice(0,2) + ".json";
  var lang_url_path = "/static/js/datatable/datatable-langs/" + lang;
  var lang_url = (location.protocol) + "//" + (location.hostname).match(/([^\.]*)\.([^\.]*)$/)[0] + lang_url_path;
  lang_url = 'https://ermile.com' + lang_url_path;

  $('.datatable', this).parents('.panel').fadeOut(100);
  ...
  .dataTable({
    // "ajax":
    // {
    //   "url": "http://cp.amon.dev/tags/list",
    //   "type": "POST"
    // }
    // "ajax": "http://ermile.dev/static/js/datatable/data/arrays.txt",
    // "ajax": "http://cp.amon.dev/tags/list",
    // "type": "POST",
    // "deferRender": true,
